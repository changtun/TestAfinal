...
enum AM_REC_ErrorCode
{
	...
	AM_REC_ERR_FILE_TOO_LARGE,			/**< file exceeds the implementation-defined maximum file size or 
											the process's file size limit, like EFBIG*/
...
enum AM_REC_EventType
{
	...
	AM_REC_EVT_UPDATE_DATABASE,			/**< 数据库更新，用于文件数据库的同步*/
	AM_REC_EVT_END
};
