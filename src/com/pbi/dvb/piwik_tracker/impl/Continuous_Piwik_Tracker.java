 ...
 */
public class Continuous_Piwik_Tracker extends BasePiwikTracker
{
    /**
     * 
     * @param apiUrl
     ...
     */
    public Continuous_Piwik_Tracker(final String apiUrl)
        throws PiwikException
    {
        super(apiUrl);
    }
     ...
     * @throws PiwikException
     */
    public Continuous_Piwik_Tracker(final int idSite, final String apiUrl, final HttpServletRequest request)
        throws PiwikException
    {
