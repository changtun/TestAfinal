...
******************************************************************************/
#ifndef __NPO_RUNTIME_H__
#define __NPO_RUNTIME_H__
...
static void RuntimeNPClassDeallocate(NPObject *npobj);
  ...
  static bool RuntimeNPClassInvokeDefault(NPObject *npobj, const NPVariant
  ...
  class RuntimeNPObject: public NPObject
  {
    public:
      ...
      {
          return NPVARIANT_IS_INT32(v) || NPVARIANT_IS_DOUBLE(v);
      };
    ...
    protected:
      ...
      RuntimeNPObject(NPP instance, const NPClass *aClass): _instance(instance)
      {
      ...
      enum InvokeResult
      {
          ...
          INVOKERESULT_INVALID_VALUE = 4,  /* throws invalid value in
            assignment */
      ...
      template <class RuntimeNPObject> friend bool RuntimeNPClassInvoke        (NPObject *npobj, NPIdentifier name, const NPVariant *args, uint32_t  argCount, NPVariant *result);
      friend bool RuntimeNPClassInvokeDefault(NPObject *npobj, const NPVariant  *args, uint32_t argCount, NPVariant *result);
      ...
      virtual InvokeResult invoke(int index, const NPVariant *args, uint32_t
        argCount, NPVariant &result);
      virtual InvokeResult invokeDefault(const NPVariant *args, uint32_t
        argCount, NPVariant &result);
  ...
  template <class T> class RuntimeNPClass: public NPClass
  {
    ...
    protected:
      ...
      template <class RuntimeNPObject> friend NPObject *RuntimeNPClassAllocate
        (NPP instance, NPClass *aClass);
      template <class RuntimeNPObject> friend bool RuntimeNPClassHasMethod
        (NPObject *npobj, NPIdentifier name);
      template <class RuntimeNPObject> friend bool RuntimeNPClassHasProperty
        (NPObject *npobj, NPIdentifier name);
      template <class RuntimeNPObject> friend bool RuntimeNPClassGetProperty
        (NPObject *npobj, NPIdentifier name, NPVariant *result);
      template <class RuntimeNPObject> friend bool RuntimeNPClassSetProperty
        (NPObject *npobj, NPIdentifier name, const NPVariant *value);
      template <class RuntimeNPObject> friend bool RuntimeNPClassRemoveProperty
        (NPObject *npobj, NPIdentifier name);
      template <class RuntimeNPObject> friend bool RuntimeNPClassInvoke
        (NPObject *npobj, NPIdentifier name, const NPVariant *args, uint32_t
        argCount, NPVariant *result);
  ...
  template <class T> inline void RuntimeNPObject::InstantObj(NPObject * &obj)
  {
      if (!obj)
        obj = NPN_CreateObject(_instance, RuntimeNPClass<T>::getClass());
  }

  template <class T> static NPObject *RuntimeNPClassAllocate(NPP instance,
    NPClass *aClass)
  {
  ...
  template <class T> static bool RuntimeNPClassHasMethod(NPObject *npobj,
    NPIdentifier name)
  {
  ...
  template <class T> static bool RuntimeNPClassHasProperty(NPObject *npobj,
    NPIdentifier name)
  {
      const RuntimeNPClass<T>  *vClass = static_cast<RuntimeNPClass<T>  *> (npobj->_class);
  ...
  template <class T> static bool RuntimeNPClassGetProperty(NPObject *npobj,
    NPIdentifier name, NPVariant *result)
  {
      RuntimeNPObject *vObj = static_cast<RuntimeNPObject *> (npobj);
      if (vObj->isValid())
      {
          const RuntimeNPClass<T>  *vClass = static_cast<RuntimeNPClass<T>  *>
            (npobj->_class);
  ...
  template <class T> static bool RuntimeNPClassSetProperty(NPObject *npobj,
  ...
  template <class T> static bool RuntimeNPClassRemoveProperty(NPObject *npobj,
    NPIdentifier name)
  {
      RuntimeNPObject *vObj = static_cast<RuntimeNPObject *> (npobj);
      if (vObj->isValid())
  ...
  template <class T> static bool RuntimeNPClassInvoke(NPObject *npobj,
    NPIdentifier name, const NPVariant *args, uint32_t argCount, NPVariant
    *result)
  {
      RuntimeNPObject *vObj = static_cast<RuntimeNPObject *> (npobj);
      if (vObj->isValid())
    ...
    *args, uint32_t argCount, NPVariant *result)
  {
    ...
    if (vObj->isValid())
    {
      return vObj->returnInvokeResult(vObj->invokeDefault(args, argCount,
        *result));
    }
    return false;
  }

  template <class T> RuntimeNPClass<T>::RuntimeNPClass()
  {
      ...
      if (T::propertyCount> 0)
      {
          ...
          if (propertyIdentifiers)
            NPN_GetStringIdentifiers(const_cast<const NPUTF8 **> (T::propertyNames), T::propertyCount, propertyIdentifiers);
      }
      ...
      if (T::methodCount > 0)
      {
          ...
          if (methodIdentifiers)
            NPN_GetStringIdentifiers(const_cast < const NPUTF8 ** > (T::methodNames), T::methodCount, methodIdentifiers);
      }
  ...
  template <class T> RuntimeNPObject *RuntimeNPClass<T>::create(NPP instance)
    const
  {
      return new T(instance, this);
  }

  template <class T> int RuntimeNPClass<T>::indexOfMethod(NPIdentifier name)
    const
  {
      if (methodIdentifiers)
      {
  ...
  template <class T> int RuntimeNPClass<T>::indexOfProperty(NPIdentifier name)
    const
  {
      if (propertyIdentifiers)
      {
