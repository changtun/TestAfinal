...
static tmErrorCode_t iTDA10025_SetPowerState(tmUnitSelect_t tUnit, tmPowerState_t ePowerState);
...
)
{
    ...
    if (err == TM_OK || err == TDA10025_ERR_NOT_INITIALIZED)
    {
        ...
        else 
        {
            ...
            tmDBGPRINTEx(DEBUGLVL_INOUT, "tmbslTDA10025_Open(0x%08X)\n", tUnit);
    ...
    tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmbslTDA10025_Open(0x%08X) failed.\n", tUnit));
...
)
{
    ...
    tmDBGPRINTEx(DEBUGLVL_INOUT, "tmbslTDA10025_HwInit(0x%08X)\n", tUnit);
...
)
{
    ...
    tmDBGPRINTEx(DEBUGLVL_INOUT, "tmbslTDA10025_StartLock(0x%08X)\n", tUnit);
...
)
{
    ...
    tmDBGPRINTEx(DEBUGLVL_INOUT, "tmbslTDA10025_GetLockStatus(0x%08X)\n", tUnit);
...
)
{
    ...
    tmDBGPRINTEx(DEBUGLVL_INOUT, "iTDA10025_HwInit(0x%08X)\n", tUnit);
    ...
    if (err == TM_OK)
    {
        ...
        if (err == TM_OK)
        {
            ...
            case HCDP_SAMPLE_ES1:
                ...
                pObj->sPllConfig.uPLLMFactor = TDA10025_ES1_PLL_DEFAULT_M;
                pObj->sPllConfig.lPLLNFactor = TDA10025_ES1_PLL_DEFAULT_N;

                pObj->sPllConfig.lPllCtl0Ind = TDA10025_ES1_PLL_CTL_0_IND_VALUE;
                pObj->sPllConfig.lPllCtl1Ind = TDA10025_ES1_PLL_CTL_1_IND_VALUE;
                pObj->sPllConfig.lPllCtl2Ind = TDA10025_ES1_PLL_CTL_2_IND_VALUE;
                pObj->sPllConfig.lPllCtl3Ind = TDA10025_ES1_PLL_CTL_3_IND_VALUE;
                pObj->sPllConfig.uPllValue   = TDA10025_ES1_PLL_VALUE;
                break;
            case HCDP_SAMPLE_ES2:
                pObj->eHwSample              = TDA10025_HwSampleVersion_ES2;
                pObj->sPllConfig.uPLLMFactor = TDA10025_ES2_PLL_DEFAULT_M;
                pObj->sPllConfig.lPLLNFactor = TDA10025_ES2_PLL_DEFAULT_N;

                pObj->sPllConfig.lPllCtl0Ind = TDA10025_ES2_PLL_CTL_0_IND_VALUE;
                pObj->sPllConfig.lPllCtl1Ind = TDA10025_ES2_PLL_CTL_1_IND_VALUE;
                pObj->sPllConfig.lPllCtl2Ind = TDA10025_ES2_PLL_CTL_2_IND_VALUE;
                pObj->sPllConfig.lPllCtl3Ind = TDA10025_ES2_PLL_CTL_3_IND_VALUE;
                pObj->sPllConfig.uPllValue   = TDA10025_ES2_PLL_VALUE;
                break;
            default:
    ...
    /* initialise PLL for each path to define the clock values */
    if (err == TM_OK)
    {
        /* Configure the PLL */
        err = iTDA10025_ConfigurePLL(tUnit);
    }
    ...
    if (err == TM_OK)
    {
        err = tmbslHCDP_SetFECMode(tUnit, tmFrontEndFECModeAnnexA);
    }
...
)
{
    ...
    tmDBGPRINTEx(DEBUGLVL_INOUT, "iTDA10025_ConfigurePLL(0x%08X)\n", tUnit);
    ...
    if (err == TM_OK)
    {
        ...
        if (err == TM_OK)
        {
            err = iTDA10025_WriteBit(tUnit, TDA10025_PLL_CTL_0_IND, TDA10025_M_MSB_MSK | TDA10025_P_MSK, pObj->sPllConfig.lPllCtl0Ind);
        }
        ...
        {
            uSamplingClock = (UInt32)( pObj->sPllConfig.uPllValue / TDA10025_ES1_PLL_SAMPLING_CLOCK_DIVIDER );
            uDClock = (UInt32)( pObj->sPllConfig.uPllValue / TDA10025_ES1_PLL_D_CLOCK_DIVIDER );

            err = tmbslHCDP_SetClocks(tUnit, uSamplingClock, uDClock);
        }
        else if (pObj->eHwSample == TDA10025_HwSampleVersion_ES2)
        {
            uSamplingClock = (UInt32)( pObj->sPllConfig.uPllValue / TDA10025_ES2_PLL_SAMPLING_CLOCK_DIVIDER );
            uDClock = (UInt32)( pObj->sPllConfig.uPllValue / TDA10025_ES2_PLL_D_CLOCK_DIVIDER );
...
)
{
    ...
    tmDBGPRINTEx(DEBUGLVL_INOUT, "iTDA10025_EnablePLL(0x%08X)\n", tUnit);
    ...
    tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "iTDA10025_EnablePLL(0x%08X) failed.\n", tUnit));
    ...
    if (ePowerState == tmPowerOn)
    {
        ...
        if (err == TM_OK)
        {
            if (pObj->sCfg.eCDP == TDA10025_CDP_0)
            {
                ...
                /* Start clocks CDP0 */
                uMask = TDA10025_CLK_CDP0_CORE_MSK | TDA10025_CLK_CDP0_A2D_MSK |
                        TDA10025_CLK_CDP0_ADC_MSK | TDA10025_CLK_CDP1_ADC_MSK |
            ...
            else /* pObj->sCfg.eCDP == TDA10025_CDP_1 */
            {
                ...
                /* Start clocks CDP1 */
                uMask = TDA10025_CLK_CDP1_CORE_MSK | TDA10025_CLK_CDP1_A2D_MSK |
                        TDA10025_CLK_CDP0_ADC_MSK | TDA10025_CLK_CDP1_ADC_MSK |
                        TDA10025_CLK_SER_TS_MSK;
                uValue = uMask;
                err = iTDA10025_WriteBit(tUnit,
        ...
        if ((err == TM_OK) && (pObj->sCfg.eTsMode == TDA10025_TsModeSerial))
        {
            ...
            if( pObj->sCfg.eTsReverse == TDA10025_TsCfg_Msb_First)
            {
                /* reverse byte -> Msb First */
                uValue &= (UInt16)~TDA10025_OUT_REVERSE_MSK;
            }
            else
            {
                /* reverse byte -> Lsb First  */
                uValue |= TDA10025_OUT_REVERSE_MSK;
            }

            if( pObj->sCfg.ePSync == TDA10025_TsCfg_At_First_Sync_Byte )
            {
                /* pSync byte -> 0 */
                uValue &= (UInt16)~TDA10025_OUT_PSYNC_MSK;
            }
            else
            {
                /* pSync byte -> 1  */
                uValue |= TDA10025_OUT_PSYNC_MSK;
            }
            ...
            if (pObj->sCfg.eCDP == TDA10025_CDP_0)
            {
                err = iTDA10025_WriteBit(tUnit, TDA10025_DEMOD0_TS_CFG_IND, TDA10025_OUT_CLKDIV_MSK|TDA10025_OUT_CLKDIR_MSK|TDA10025_OUT_CLKPOL_MSK|TDA10025_OUT_PSYNC_MSK|TDA10025_OUT_REVERSE_MSK, uValue);
            }
            else /* pObj->sCfg.eCDP == TDA10025_CDP_1 */
            {
                err = iTDA10025_WriteBit(tUnit, TDA10025_DEMOD1_TS_CFG_IND, TDA10025_OUT_CLKDIV_MSK|TDA10025_OUT_CLKDIR_MSK|TDA10025_OUT_CLKPOL_MSK|TDA10025_OUT_PSYNC_MSK|TDA10025_OUT_REVERSE_MSK, uValue);
            }
        }
...
)
{
    ...
    tmDBGPRINTEx(DEBUGLVL_BLAB, "iTDA10025_IPWrite(0x%08X)\n", pObj->tUnit);
    ...
    tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "iTDA10025_IPWrite(0x%08X) failed.\n", pObj->tUnit));
...
)
{
    ...
    tmDBGPRINTEx(DEBUGLVL_BLAB, "iTDA10025_IPRead(0x%08X)\n", pObj->tUnit);
    ...
    tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "iTDA10025_IPRead(0x%08X) failed.\n", pObj->tUnit));
...
)
{
    ...
    tmDBGPRINTEx(DEBUGLVL_BLAB, "iTDA10025_Write(0x%08X)\n", tUnit);
    ...
    tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "iTDA10025_Write(0x%08X) failed.\n", pObj->tUnit));
...
)
{
    ...
    tmDBGPRINTEx(DEBUGLVL_BLAB, "iTDA10025_Read(0x%08X)\n", tUnit);
    ...
    tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "iTDA10025_Read(0x%08X) failed.\n", pObj->tUnit));
...
)
{
    ...
    tmDBGPRINTEx(DEBUGLVL_BLAB, "iTDA10025_WriteBit(0x%08X)\n", tUnit);
    ...
    tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "iTDA10025_WriteBit(0x%08X) failed.\n", pObj->tUnit));
...
)
{
    ...
    tmDBGPRINTEx(DEBUGLVL_INOUT, "iTDA10025_Wait(0x%08X)\n", pObj->tUnit);
