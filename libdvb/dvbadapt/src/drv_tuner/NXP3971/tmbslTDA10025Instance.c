...
)
{
    ...
    pDrvObject->sPllConfig.uXtal = TDA10025_DEFAULT_XTAL;
    pDrvObject->sPllConfig.uPLLMFactor = TDA10025_ES2_PLL_DEFAULT_M; /* eventually overwritten in tmbslTDA10025_HwInit for ES1 */
    pDrvObject->sPllConfig.lPLLNFactor = TDA10025_ES2_PLL_DEFAULT_N;
    pDrvObject->sPllConfig.bPLLPFactor = TDA10025_PLL_DEFAULT_P;
