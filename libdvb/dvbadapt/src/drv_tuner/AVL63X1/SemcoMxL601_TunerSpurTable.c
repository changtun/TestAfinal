...
SEM_CHAN_DEPENDENT_SPUR_REGISTER_T MxL601_SPUR_REGISTER = 
{ 4, {SEM_DFE_RFLUT_SWP1_REG, SEM_DFE_RFLUT_DIV_MOD_REG, SEM_DFE_REFLUT_BYP_REG, SEM_DFE_REFSX_INT_MOD_REG} };
...
// Table : 24
// NTSC XTAL=16MHz LIF
SEM_CHAN_DEPENDENT_FREQ_TABLE_T NTSC_FREQ_LUT_XTAL_16MHZ_LIF[] = 
{ 
...
// Table : 25
// NTSC XTAL=24MHz
SEM_CHAN_DEPENDENT_FREQ_TABLE_T NTSC_FREQ_LUT_XTAL_24MHZ[] = 
{ 
...
// Table : 26
// NTSC HRC XTAL=16MHz
SEM_CHAN_DEPENDENT_FREQ_TABLE_T NTSC_FREQ_LUT_HRC_16MHZ[] = 
{ 
...
// Table : 27
// NTSC HRC XTAL=24MHz
SEM_CHAN_DEPENDENT_FREQ_TABLE_T NTSC_FREQ_LUT_HRC_24MHZ[] = 
{ 
  {1, 0x1D, 0x17, 0x00, 0x90},
...
// Table : 28
// NTSC IRC XTAL=16MHz
SEM_CHAN_DEPENDENT_FREQ_TABLE_T NTSC_FREQ_LUT_IRC_16MHZ[] = 
{ 
  {1, 0x1C, 0x17, 0x00, 0xD8},
...
// Table : 29
// NTSC IRC XTAL=24MHz
SEM_CHAN_DEPENDENT_FREQ_TABLE_T NTSC_FREQ_LUT_IRC_24MHZ[] = 
{ 
  {1, 0x1D, 0x17, 0x00, 0x90},
...
SEM_CHAN_DEPENDENT_FREQ_TABLE_T PAL_BG_7MHZ_LUT_XTAL_16MHZ_LIF[] = 
{ 
  {1, 0x1D, 0x17, 0x00, 0xD8},
...
SEM_CHAN_DEPENDENT_FREQ_TABLE_T PAL_BG_7MHZ_LUT_XTAL_24MHZ[] = 
{ 
  {1, 0x1D, 0x17, 0x00, 0x90},
...
SEM_CHAN_DEPENDENT_FREQ_TABLE_T PAL_BG_8MHZ_LUT_XTAL_16MHZ_LIF[] = 
{ 
  {1, 0x1D, 0x17, 0x00, 0xD8},
...
SEM_CHAN_DEPENDENT_FREQ_TABLE_T PAL_BG_8MHZ_LUT_XTAL_24MHZ[] = 
{ 
  {1, 0x1D, 0x17, 0x00, 0x90},
...
SEM_CHAN_DEPENDENT_FREQ_TABLE_T PAL_D_LUT_XTAL_16MHZ_LIF[] = 
{ 
  {1, 0x1D, 0x17, 0x00, 0xD8},
...
// Table : 36
// PAL-D XTAL=24MHz
SEM_CHAN_DEPENDENT_FREQ_TABLE_T PAL_D_LUT_XTAL_24MHZ[] = 
{ 
  {1, 0x1D, 0x17, 0x00, 0x90},
...
SEM_CHAN_DEPENDENT_FREQ_TABLE_T PAL_I_LUT_XTAL_16MHZ_LIF[] = 
{ 
  {1, 0x1D, 0x17, 0x00, 0xD8},
...
// Table : 38
// PAL-I XTAL=24MHz
SEM_CHAN_DEPENDENT_FREQ_TABLE_T PAL_I_LUT_XTAL_24MHZ[] = 
{ 
  {1, 0x1D, 0x17, 0x00, 0x90},
...
// Table : 39
// SECAM L XTAL=16MHz
SEM_CHAN_DEPENDENT_FREQ_TABLE_T SECAM_L_LUT_XTAL_16MHZ[] = 
{ 
  {1, 0x1D, 0x17, 0x00, 0xD8},
...
// Table : 40
// SECAM-L XTAL=24MHz
SEM_CHAN_DEPENDENT_FREQ_TABLE_T SECAM_L_LUT_XTAL_24MHZ[] = 
{ 
  {1, 0x1D, 0x17, 0x00, 0x90},
...
SEM_CHAN_DEPENDENT_FREQ_TABLE_T PAL_D_LUT_XTAL_16MHZ_HIF[] = 
{ 
  {1, 0x1D, 0x17, 0x00, 0xD8},
...
SEM_CHAN_DEPENDENT_FREQ_TABLE_T PAL_I_LUT_XTAL_16MHZ_HIF[] = 
{ 
  {1, 0x1D, 0x17, 0x00, 0xD8},
...
SEM_CHAN_DEPENDENT_FREQ_TABLE_T PAL_BG_7MHZ_LUT_XTAL_16MHZ_HIF[] = 
{ 
  {1, 0x1D, 0x17, 0x00, 0xD8},
...
// Table : 53
// PAL-BG XTAL=16MHz HIF
SEM_CHAN_DEPENDENT_FREQ_TABLE_T PAL_BG_8MHZ_LUT_XTAL_16MHZ_HIF[] = 
{ 
  {1, 0x1D, 0x17, 0x00, 0xD8},
...
// Table : 54
// NTSC XTAL=16MHz HIF
SEM_CHAN_DEPENDENT_FREQ_TABLE_T NTSC_FREQ_LUT_XTAL_16MHZ_HIF[] = 
{ 
  {1, 0x1C, 0x17, 0x00, 0xD8},
...
// Table : 60
// Digital Cable 6MHz
SEM_CHAN_DEPENDENT_FREQ_TABLE_T DIG_CABLE_FREQ_LUT_BW_6MHZ[] = 
{ 
  {1, 0x1C, 0x17, 0x00, 0xD8},
  {0, 0, 0, 0, 0},
};
...
// Table : 61
// Digital Cable 8MHz
SEM_CHAN_DEPENDENT_FREQ_TABLE_T DIG_CABLE_FREQ_LUT_BW_8MHZ[] = 
{ 
  {1, 0x1C, 0x17, 0x00, 0xD8},
  {0, 0, 0, 0, 0},
};
...
SEM_CHAN_DEPENDENT_FREQ_TABLE_T DIG_TERR_FREQ_LUT_BW_6MHZ[] = 
{ 
  {1, 0x1C, 0x17, 0x00, 0xD8},
  {0, 0, 0, 0, 0},
};
...
SEM_CHAN_DEPENDENT_FREQ_TABLE_T DIG_TERR_FREQ_LUT_BW_7MHZ[] = 
{ 
  {1, 0x1C, 0x17, 0x00, 0xD8},
  {0, 0, 0, 0, 0},
};
...
SEM_CHAN_DEPENDENT_FREQ_TABLE_T DIG_TERR_FREQ_LUT_BW_8MHZ[] = 
{ 
  {1, 0x1C, 0x17, 0x00, 0xD8},
  {0, 0, 0, 0, 0},
};
